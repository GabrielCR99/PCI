...
public class SecondPartFragment extends CustomFragment implements UniversitiesAdapter.RecyclerViewClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_newproject_part2, container, false);
        setUniversities();
        setComponents();
        return view;
    }
    ...
    public void setComponents() {
        super.setComponents();
        universityRecyclerView = view.findViewById(R.id.recycler_universities);
        filteredRecyclerView = view.findViewById(R.id.recycler_selected_universities);
        ...
        adapter = new UniversitiesAdapter(universities, context, this, "FILTER");
