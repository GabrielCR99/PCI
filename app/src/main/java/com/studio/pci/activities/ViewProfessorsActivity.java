...
import com.studio.pci.adapters.ProfessorsViewAdapter;
...
public class ViewProfessorsActivity extends AppCompatActivity {
    ...
    private ProfessorsViewAdapter adapter;
    ...
    private void setRecyclerView() {
        ...
        adapter = new ProfessorsViewAdapter(professors, uploads, this);
    ...
    private void search(String s) {
        ...
        ProfessorsViewAdapter professorsFiltered = new ProfessorsViewAdapter(professorFilter,uploadFilter,this);
